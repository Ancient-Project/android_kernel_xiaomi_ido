...
# Bypass maybe-uninitialized warnings
KBUILD_CFLAGS	+= $(call cc-disable-warning,maybe-uninitialized,)

# Needed to unbreak GCC 7.x and above
KBUILD_CFLAGS   += $(call cc-option,-fno-store-merging,)

# Skip unfixable warnings generated by GCC
KBUILD_CFLAGS	+= -Wno-cpp -Wno-unused-const-variable -Wno-memset-transposed-args

# Bypass all GCC 7.x warnings
KBUILD_CFLAGS	+= -Wno-format-overflow -Wno-duplicate-decl-specifier \
		   -Wno-memset-elt-size -Wno-switch-unreachable \
		   -Wno-int-in-bool-context -Wno-array-bounds \
		   -Wno-bool-operation
...
KBUILD_CFLAGS	+= -Ofast -Wno-nonnull
endif
